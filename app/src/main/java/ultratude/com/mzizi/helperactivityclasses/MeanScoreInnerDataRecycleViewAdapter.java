...
public class MeanScoreInnerDataRecycleViewAdapter extends RecyclerView.Adapter<MeanScoreInnerDataRecycleViewAdapter.DataHolder>{
    ...
    List<PortalStudentDetailedResults> portalResultList;
    ...
    public MeanScoreInnerDataRecycleViewAdapter(MeanScoreFrag meanScoreFrag,List<PortalStudentDetailedResults> portalResultList){
    ...
    public MeanScoreInnerDataRecycleViewAdapter.DataHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(fragWeakReference.get().getContext()).inflate(R.layout.meanscore_innerrecycler_items, parent, false);
    ...
    public void onBindViewHolder(DataHolder holder, int position) {
            ...
            PortalStudentDetailedResults portalStudentResult = portalResultList.get(position);
    ...
    public class DataHolder extends RecyclerView.ViewHolder{
        ...
        void bind(PortalStudentDetailedResults portalStudentDetailedResults, int position){
