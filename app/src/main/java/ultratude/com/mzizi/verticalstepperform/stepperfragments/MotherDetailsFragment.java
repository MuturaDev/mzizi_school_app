...
public class MotherDetailsFragment extends Fragment implements StepperFormListener {

    //Stepper Form
    private AlarmNameStep motherFirstNameStep;
    private AlarmNameStep motherMiddleName;
    private AlarmNameStep motherSecondName;
    ...
    //This for saving
    public static final String MOTHER_FIRST_NAME   =  "motherFirstNameStep";
    public static final String MOTHER_MIDDLE_NAME =   "motherMiddleName";
    public static final String MOTHER_SECOND_NAME=   "motherSecondName";
    public static final String PHONE_NUMBER =         "phoneNumber";
    public static final String EMAIL_ADDRESS =        "emailAddress";
    public static final String NATIONAL_ID =          "nationalID";

    public MotherDetailsFragment(){}

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.mother_details_fragment_layout, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        motherFirstNameStep = new AlarmNameStep(stepTitles[0]);
        motherMiddleName = new AlarmNameStep(stepTitles[1]);
        motherSecondName = new AlarmNameStep(stepTitles[2]);
