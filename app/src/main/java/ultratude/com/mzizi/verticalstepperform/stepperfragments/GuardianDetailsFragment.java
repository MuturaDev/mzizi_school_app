...
public class GuardianDetailsFragment extends Fragment implements StepperFormListener {

    //Stepper Form
    private AlarmNameStep guardianFirstNameStep;
    private AlarmNameStep guardianMiddleName;
    private AlarmNameStep guardianSecondName;
    ...
    //This for saving
    public static final String GUARDIAN_FIRST_NAME   =  "guardianFirstNameStep";
    public static final String GUARDIAN_MIDDLE_NAME =   "guardianMiddleName";
    public static final String GUARDIAN_SECOND_NAME=   "guardianSecondName";
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        return inflater.inflate(R.layout.guardian_details_fragment_layout, container, false);
    }
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        guardianFirstNameStep = new AlarmNameStep(stepTitles[0]);
        guardianMiddleName = new AlarmNameStep(stepTitles[1]);
        guardianSecondName = new AlarmNameStep(stepTitles[2]);
        ...
        verticalStepperForm.setup(this, guardianFirstNameStep,
                guardianMiddleName,
                guardianSecondName,
                phoneNumber,
                emailAddress,
