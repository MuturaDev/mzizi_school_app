package ultratude.com.mzizi.multiplechoicequestions.question;
...
import ultratude.com.mzizi.multiplechoicequestions.StepperQuestionListener;
...
public class VerticalStepperFormView extends LinearLayout {
    ...
    private StepperQuestionListener listener;
     ...
     *
     * @param StepperQuestionListener The listener for the stepper form events.
     ...
     */
    public Builder setup(StepperQuestionListener StepperQuestionListener, Step... steps) {
        return new Builder(this, StepperQuestionListener, steps);
    }
     ...
     * @return An instance of the stepper form builder. Use it to configure and initialize the form.
     */
    public Builder setup(StepperQuestionListener StepperQuestionListener, List<Step> steps) {
        Step[] stepsArray = steps.toArray(new Step[0]);
        return new Builder(this, StepperQuestionListener, stepsArray);
    }
    ...
    void initializeForm(StepperQuestionListener listener, StepHelper[] stepsArray) {
    ...
    public synchronized void openStep(int stepToOpenPosition, boolean useAnimations) {
    ...
    private synchronized void attemptToCompleteForm(boolean isCancellation) {
        ...
        if (openStepPosition >= 0 && openStepPosition < stepHelpers.size() && (isCancellation || areAllStepsCompleted())) {
            ...
            if (listener != null) {
                if (!isCancellation) {
                    listener.onCompletedQuestion();
                } else {
                    listener.onCancelledQuestion();
                }
            }
