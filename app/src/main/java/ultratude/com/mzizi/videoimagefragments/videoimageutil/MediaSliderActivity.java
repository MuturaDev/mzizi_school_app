        ...
        mPager.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageScrolled(int i, float v, int i1) {
                if (mediaType.equalsIgnoreCase("video")) {
                    ...
                    View viewTag = mPager.findViewById(R.id.pager);
                ...
                if (mediaType.equalsIgnoreCase("video")) {
                   View viewTag = mPager.findViewWithTag("view" + i);
                    ...
                    if (simpleExoPlayerView.getPlayer() != null) {
                        ...
                        // extractYoutubeUrl(urlList.get(i), simpleExoPlayerView);
    ...
    private class ScreenSlidePagerAdapter extends PagerAdapter {
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            if (token.equalsIgnoreCase("image")) {
               ...
               // extractYoutubeUrl(urlList.get(position), simpleExoPlayerView);
