package ultratude.com.mzizi.elegantnumberbutton;
...
public class ElegantNumberButton extends RelativeLayout {
    ...
    private void initView() {
        ...
        final int defaultColor = res.getColor(R.color.homeText);
        final int defaultTextColor = res.getColor(R.color.white);
