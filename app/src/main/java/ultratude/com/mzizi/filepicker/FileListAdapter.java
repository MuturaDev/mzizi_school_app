...
public class FileListAdapter extends RecyclerView.Adapter<FileListAdapter.ViewHolder> {
    ...
    public FileListAdapter(ArrayList<MediaFile> mediaFiles, Context context) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        //Log.d(context.getPackageName().toUpperCase(), "File Path: " + holder.filePath.getText().toString());
