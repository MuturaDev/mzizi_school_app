package ultratude.com.mzizi.filepicker.adapter;
...
import ultratude.com.mzizi.filepicker.utils.TimeUtils;
import ultratude.com.mzizi.filepicker.view.SquareImage;
...
public class FileGalleryAdapter extends MultiSelectionAdapter<FileGalleryAdapter.ViewHolder>
    ...
    public void openCamera(boolean forVideo) {
        ...
        if (!dir.exists() && !dir.mkdir()) {
            Log.d(activity.getPackageName().toUpperCase(), "onClick: " +
