...
//        int ff = 10/0;
        ...
        show_tutorial_ID = findViewById(R.id.show_tutorial_ID);
       ...
       // new StaffDao(this).deleteStaff();
        ...
        apply_leave_CardId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ScreenNameEnums screenName = ScreenNameEnums.APPLY_LEAVE;
                boolean access  =  new ScreenDAO(HomeScreen.this).requestAccessToThisScreen(new StaffOperationsDAO(HomeScreen.this).getStaffOperationsList(), screenName);
        ...
        manage_discipline_CardId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ScreenNameEnums screenName = ScreenNameEnums.MANAGE_DISCPLINARY;
                boolean access  = new ScreenDAO(HomeScreen.this).requestAccessToThisScreen(new StaffOperationsDAO(HomeScreen.this).getStaffOperationsList(), screenName);
        ...
        manage_attendance_CardId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ScreenNameEnums screenName = ScreenNameEnums.MANAGE_ATTENDANCE;
                boolean access  =  new ScreenDAO(HomeScreen.this).requestAccessToThisScreen(new StaffOperationsDAO(HomeScreen.this).getStaffOperationsList(), screenName);
        ...
        view_payslip_CardId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ScreenNameEnums screenName = ScreenNameEnums.VIEW_PAYSLIP;
                boolean access  =  new ScreenDAO(HomeScreen.this).requestAccessToThisScreen(new StaffOperationsDAO(HomeScreen.this).getStaffOperationsList(), screenName);
        ...
        student_enquiry_CardId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               ...
               // Toast.makeText(HomeScreen.this, "Phase two of development", Toast.LENGTH_SHORT).show();
                ...
                ScreenNameEnums screenName = ScreenNameEnums.STUDENT_ENQUIRY;
                boolean access  = new ScreenDAO(HomeScreen.this).requestAccessToThisScreen(new StaffOperationsDAO(HomeScreen.this).getStaffOperationsList(), screenName);
        ...
        duty_roster_CardId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
               // Toast.makeText(HomeScreen.this, "Coming soon", Toast.LENGTH_SHORT).show();
                ...
                ScreenNameEnums screenName = ScreenNameEnums.DUTY_ROSTER;
                boolean access  =  new ScreenDAO(HomeScreen.this).requestAccessToThisScreen(new StaffOperationsDAO(HomeScreen.this).getStaffOperationsList(), screenName);
        ...
        manage_fuel_CardId.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ScreenNameEnums screenName = ScreenNameEnums.MANAGE_FLEET_FUEL;
                boolean access  =  new ScreenDAO(HomeScreen.this).requestAccessToThisScreen(new StaffOperationsDAO(HomeScreen.this).getStaffOperationsList(), screenName);
        ...
        fleet_service_CardID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ScreenNameEnums screenName = ScreenNameEnums.MANAGE_FLEET_SERVICE;
                boolean access  = new ScreenDAO(HomeScreen.this).requestAccessToThisScreen(new StaffOperationsDAO(HomeScreen.this).getStaffOperationsList(), screenName);
        ...
        enroll_activity_scan_CardID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                startActivity(new Intent(HomeScreen.this, EnrollActivityScan.class));
   ...
   // /this helps alot, when the app is closed, bload cast are not fired
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if(itemId == R.id.logout_id) {
            ...
            Snackbar.make((ConstraintLayout) findViewById(R.id.home_layout), "Uploading records stored locally...", Snackbar.LENGTH_LONG).show();
        }else {
...
//                sendRequestForAllStaff(context, apiInterface, staffRequest, staff, alertd);
                ...
                Snackbar.make((ConstraintLayout) findViewById(R.id.home_layout), "Loading records...", Snackbar.LENGTH_LONG).show();
