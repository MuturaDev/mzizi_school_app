...
//                .build();
        ...
        btn_daily_tranport_ID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ScreenNameEnums screenName = ScreenNameEnums.DAILTY_TRANSPORT;
                boolean access  =   new ScreenDAO(ManageTransportScreen.this).requestAccessToThisScreen(new StaffOperationsDAO(ManageTransportScreen.this).getStaffOperationsList(), screenName);
                ...
                if(access){
                    ...
                    if ((lmanager.isProviderEnabled(LocationManager.GPS_PROVIDER))) {
                        ...
                        AlertDialog.Builder alert = new AlertDialog.Builder(ManageTransportScreen.this);
                   ...
                   AlertDialog.Builder accessDeniedAlert = new AlertDialog.Builder(ManageTransportScreen.this);
        ...
        btn_trip_transport_cases_ID.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ScreenNameEnums screenName = ScreenNameEnums.TRIP_TRANSPORT;
                boolean access  =   new ScreenDAO(ManageTransportScreen.this).requestAccessToThisScreen(new StaffOperationsDAO(ManageTransportScreen.this).getStaffOperationsList(), screenName);

                if(access){
                    Intent intent = new Intent(ManageTransportScreen.this, TripTransport.class);
