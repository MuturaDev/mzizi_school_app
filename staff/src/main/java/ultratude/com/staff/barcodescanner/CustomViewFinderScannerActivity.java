...
//        };
    ...
    public void handleResult(Result rawResult) {
        ...
        intent.putExtra("Bus_Activity", getIntent().getStringExtra("Bus_Activity"));
        intent.putExtra("Bus_Session", getIntent().getIntExtra("Bus_Session", 0));
        intent.putExtra("Bus_Trip", getIntent().getIntExtra("Bus_Trip", 0));
        setResult(DailyTransport.RC_BARCODE_CAPTURE,intent);
