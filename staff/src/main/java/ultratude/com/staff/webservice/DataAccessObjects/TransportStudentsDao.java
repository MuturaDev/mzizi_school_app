...
public class TransportStudentsDao {
    ...
    public TransportStudentsDao(Context context){

        this.context = context;
        sqhelp = DatabaseConnectionOpenHelper.getInstance(context);
    }
    public String saveAllStudents(ProgressDialog alertd , List<TransportStudents> studentList){
...
//            }
    ...
    public List<TransportStudents> getAllStudents(){
    ...
    public boolean deleteAllTransportStudents(){
